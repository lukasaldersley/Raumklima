...
extends ApplicationFrame {
    public StackedBarChart3DDemo2(String string) {
        super(string);
        JPanel jPanel = StackedBarChart3DDemo2.createDemoPanel();
    ...
    private static JFreeChart createChart(CategoryDataset categoryDataset) {
        JFreeChart jFreeChart = ChartFactory.createStackedBarChart3D((String)"Stacked Bar Chart 3D Demo 2", (String)"Category", (String)"Value", (CategoryDataset)categoryDataset, (PlotOrientation)PlotOrientation.VERTICAL, (boolean)true, (boolean)true, (boolean)false);
    ...
    public static JPanel createDemoPanel() {
        JFreeChart jFreeChart = StackedBarChart3DDemo2.createChart(StackedBarChart3DDemo2.createDataset());
    ...
    public static void main(String[] arrstring) {
        ...
        RefineryUtilities.centerFrameOnScreen((Window)((Object)stackedBarChart3DDemo2));
