...
extends ApplicationFrame {
    public CategoryMarkerDemo2(String string) {
        super(string);
        JPanel jPanel = CategoryMarkerDemo2.createDemoPanel();
    ...
    private static JFreeChart createChart(CategoryDataset categoryDataset) {
        JFreeChart jFreeChart = ChartFactory.createLineChart((String)"Category Marker Demo 2", (String)"Category", (String)"Count", (CategoryDataset)categoryDataset, (PlotOrientation)PlotOrientation.VERTICAL, (boolean)true, (boolean)true, (boolean)false);
        ...
        CategoryMarker categoryMarker = new CategoryMarker((Comparable)((Object)"Category 4"), (Paint)new Color(0, 0, 255, 25), (Stroke)new BasicStroke(1.0f));
    ...
    public static JPanel createDemoPanel() {
        JFreeChart jFreeChart = CategoryMarkerDemo2.createChart(CategoryMarkerDemo2.createDataset());
    ...
    public static void main(String[] arrstring) {
        ...
        RefineryUtilities.centerFrameOnScreen((Window)((Object)categoryMarkerDemo2));
