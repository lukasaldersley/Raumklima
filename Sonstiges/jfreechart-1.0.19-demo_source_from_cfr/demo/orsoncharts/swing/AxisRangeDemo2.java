...
extends JFrame {
    public AxisRangeDemo2(String string) {
        super(string);
    ...
    public static JPanel createDemoPanel() {
        ...
        CategoryDataset3D categoryDataset3D = AxisRangeDemo2.createDataset();
        Chart3D chart3D = Chart3DFactory.createBarChart((String)"AxisRangeDemo2", (String)"Chart created with Orson Charts", (CategoryDataset3D)categoryDataset3D, (String)"Row", (String)"Category", (String)"Value");
        ...
        barRenderer3D.setItemLabelGenerator((CategoryItemLabelGenerator)new StandardCategoryItemLabelGenerator("%4$.2f"));
