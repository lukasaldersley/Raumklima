...
import demo.orsoncharts.LineChart3D1;
...
extends JFrame {
    public LineChart3DDemo1(String string) {
        ...
        this.getContentPane().add(LineChart3DDemo1.createDemoPanel());
    }

    public static JPanel createDemoPanel() {
        DemoPanel demoPanel = new DemoPanel(new BorderLayout());
        demoPanel.setPreferredSize(OrsonChartsDemo.DEFAULT_CONTENT_SIZE);
        CategoryDataset3D categoryDataset3D = LineChart3D1.createDataset();
        Chart3D chart3D = LineChart3D1.createChart(categoryDataset3D);
    ...
    public static void main(String[] arrstring) {
        LineChart3DDemo1 lineChart3DDemo1 = new LineChart3DDemo1("OrsonCharts: LineChart3DDemo1.java");
