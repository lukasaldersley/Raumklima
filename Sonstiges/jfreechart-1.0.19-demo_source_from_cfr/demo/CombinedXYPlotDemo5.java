...
extends ApplicationFrame {
    public CombinedXYPlotDemo5(String string) {
        super(string);
        JFreeChart jFreeChart = CombinedXYPlotDemo5.createCombinedChart();
    ...
    private static JFreeChart createCombinedChart() {
        XYDataset xYDataset = CombinedXYPlotDemo5.createDataset1();
        ...
        XYDataset xYDataset2 = CombinedXYPlotDemo5.createDataset2();
        ...
        XYPlot xYPlot2 = new XYPlot(xYDataset2, null, (ValueAxis)numberAxis2, (XYItemRenderer)standardXYItemRenderer2);
        xYPlot2.setRangeAxisLocation(AxisLocation.TOP_OR_LEFT);
        NumberAxis numberAxis3 = new NumberAxis("Domain");
        numberAxis3.setTickMarkInsideLength(5.0f);
        CombinedDomainXYPlot combinedDomainXYPlot = new CombinedDomainXYPlot((ValueAxis)numberAxis3);
        combinedDomainXYPlot.setGap(10.0);
        combinedDomainXYPlot.add(xYPlot, 1);
        combinedDomainXYPlot.add(xYPlot2, 1);
        combinedDomainXYPlot.setOrientation(PlotOrientation.VERTICAL);
        JFreeChart jFreeChart = new JFreeChart("CombinedDomainXYPlotDemo5", JFreeChart.DEFAULT_TITLE_FONT, (Plot)combinedDomainXYPlot, true);
    ...
    public static void main(String[] arrstring) {
        ...
        RefineryUtilities.centerFrameOnScreen((Window)((Object)combinedXYPlotDemo5));
