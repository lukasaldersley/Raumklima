...
extends ApplicationFrame {
    public CombinedXYPlotDemo3(String string) {
        super(string);
        JFreeChart jFreeChart = CombinedXYPlotDemo3.createCombinedChart();
    ...
    private static JFreeChart createCombinedChart() {
        ...
        TimeSeries timeSeries = CombinedXYPlotDemo3.createEURTimeSeries();
        timeSeriesCollection.addSeries(timeSeries);
        TimeSeriesCollection timeSeriesCollection2 = new TimeSeriesCollection();
        TimeSeries timeSeries2 = MovingAverage.createMovingAverage((TimeSeries)timeSeries, (String)"EUR/GBP (30 Day MA)", (int)30, (int)30);
        ...
        XYPlot xYPlot = new XYPlot((XYDataset)timeSeriesCollection, (ValueAxis)new DateAxis("Date 1"), null, (XYItemRenderer)new StandardXYItemRenderer());
        combinedRangeXYPlot.add(xYPlot, 1);
        XYPlot xYPlot2 = new XYPlot((XYDataset)timeSeriesCollection2, (ValueAxis)new DateAxis("Date 2"), null, (XYItemRenderer)new StandardXYItemRenderer());
        combinedRangeXYPlot.add(xYPlot2, 1);
        XYPlot xYPlot3 = new XYPlot((XYDataset)timeSeriesCollection3, (ValueAxis)new DateAxis("Date 3"), null, (XYItemRenderer)new XYBarRenderer(0.2));
        combinedRangeXYPlot.add(xYPlot3, 1);
        jFreeChart = new JFreeChart("Demo Chart", JFreeChart.DEFAULT_TITLE_FONT, (Plot)combinedRangeXYPlot, true);
        TextTitle textTitle = new TextTitle("This is a subtitle", new Font("SansSerif", 1, 12));
        jFreeChart.addSubtitle((Title)textTitle);
        jFreeChart.setBackgroundPaint((Paint)new GradientPaint(0.0f, 0.0f, Color.WHITE, 0.0f, 1000.0f, Color.BLUE));
    ...
    public static void main(String[] arrstring) {
        ...
        RefineryUtilities.centerFrameOnScreen((Window)((Object)combinedXYPlotDemo3));
