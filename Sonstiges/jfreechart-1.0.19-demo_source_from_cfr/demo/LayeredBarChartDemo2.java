...
extends ApplicationFrame {
    public LayeredBarChartDemo2(String string) {
        super(string);
        JPanel jPanel = LayeredBarChartDemo2.createDemoPanel();
    ...
    private static JFreeChart createChart(CategoryDataset categoryDataset) {
        JFreeChart jFreeChart = ChartFactory.createBarChart((String)"Layered Bar Chart Demo 2", (String)"Category", (String)"Value", (CategoryDataset)categoryDataset, (PlotOrientation)PlotOrientation.HORIZONTAL, (boolean)true, (boolean)true, (boolean)false);
    ...
    public static JPanel createDemoPanel() {
        JFreeChart jFreeChart = LayeredBarChartDemo2.createChart(LayeredBarChartDemo2.createDataset());
