...
public class CSV_GUI_CROSSHAIR_1 implements ChartMouseListener, KeyListener, ComponentListener{
    ...
    private CSV_GUI_CROSSHAIR_1 nextOne=null;
    private CSV_GUI_CROSSHAIR_1 previousOne=null;
    public CSV_GUI_CROSSHAIR_1(String string,int integer,CSV_GUI_CROSSHAIR_1 newPrevious,CSV_GUI_CROSSHAIR_1 newNext) {
        number=integer;
        name=string;
        if(number==1){
    ...
    public void setNextOne(CSV_GUI_CROSSHAIR_1 newNext){
        nextOne=newNext;
    }
    
    public void setPreviousOne(CSV_GUI_CROSSHAIR_1 newPrevious){
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable(){
                ...
                @Override
                public void run() {
                    new CSV_GUI_CROSSHAIR_1("Raumklima Auswertungssoftware",1,null,null);
                }
            });
    }
    ...
    public void keyPressed(KeyEvent event) {
        ...
        if(event.getKeyCode()==OPEN_KEY_ID&&event.isControlDown()){//Strg+N ?ffnet eine neue instanz der software
            ...
            setNextOne(new CSV_GUI_CROSSHAIR_1(name,++number,this,null));
        }
            ...
            CSV_GUI_CROSSHAIR_1 zw=new CSV_GUI_CROSSHAIR_1(name,number,previousOne,nextOne);
