...
extends JFrame {
    ...
    public static void main(String[] arrstring) {
        SwingUtilities.invokeLater(new Runnable(){
            ...
            public void run() {
                ...
                crosshairOverlayDemo2.setLocationRelativeTo(null);
            }
        });
    }
    ...
    implements ChartMouseListener {
        ...
        public MyDemoPanel() {
            ...
            this.yCrosshairs[0] = new Crosshair(Double.NaN, (Paint)Color.RED, (Stroke)new BasicStroke(0.0f));
            this.yCrosshairs[1] = new Crosshair(Double.NaN, (Paint)Color.BLUE, (Stroke)new BasicStroke(0.0f));
            this.yCrosshairs[2] = new Crosshair(Double.NaN, (Paint)Color.GREEN, (Stroke)new BasicStroke(0.0f));
            this.yCrosshairs[3] = new Crosshair(Double.NaN, (Paint)Color.YELLOW, (Stroke)new BasicStroke(0.0f));
            for (int i = 0; i < 4; ++i) {
