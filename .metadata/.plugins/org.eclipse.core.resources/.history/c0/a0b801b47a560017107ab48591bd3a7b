...
import demo.orsoncharts.StackedBarChart3D1;
...
extends JFrame {
    public StackedBarChart3DDemo1(String string) {
        ...
        this.getContentPane().add(StackedBarChart3DDemo1.createDemoPanel());
    }

    public static JPanel createDemoPanel() {
        DemoPanel demoPanel = new DemoPanel(new BorderLayout());
        demoPanel.setPreferredSize(OrsonChartsDemo.DEFAULT_CONTENT_SIZE);
        CategoryDataset3D categoryDataset3D = StackedBarChart3D1.createDataset();
        Chart3D chart3D = StackedBarChart3D1.createChart(categoryDataset3D);
    ...
    public static void main(String[] arrstring) {
        StackedBarChart3DDemo1 stackedBarChart3DDemo1 = new StackedBarChart3DDemo1("OrsonCharts: StackedBarChart3DDemo2.java");
