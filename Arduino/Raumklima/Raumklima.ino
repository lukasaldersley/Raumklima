...
//DIES IST NICHT DIE VERSION, DIE AUF DEM GERÄT AUF DEN BILDERN INSTALLIERT IST. DIE VERSION IST TROTZ VCS VERLOREN GEGANGEN, DA DIE VERSION IN EINEM ZUG PROGRAMMIERT WURDE OHNE JEMALS IN EINEM COMMIT ENTHALTEN GEWESEN ZU SEIN.
