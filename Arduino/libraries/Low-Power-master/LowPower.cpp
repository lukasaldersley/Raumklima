			                ...
			                usart0_t usart0, twi_t twi)
{
	...
	if (timer0 == TIMER0_OFF)	power_timer0_disable();	
	if (spi == SPI_OFF)		    power_spi_disable();
	//FALLS DAS JEMALS FUNKTIONIERT, ENTFERNE ICH DIESN KOMMENATR if (usart3 == USART3_OFF)	power_usart3_disable();
	...
	if (timer0 == TIMER0_OFF)	power_timer0_enable();	
	if (spi == SPI_OFF)			power_spi_enable();
	//GLEICHES WIE IN ZEILE 440 if (usart3 == USART3_OFF)	power_usart3_enable();
