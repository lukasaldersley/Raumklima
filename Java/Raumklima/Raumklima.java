...
public class Raumklima implements ActionListener,WindowListener,WindowStateListener,ChartMouseListener,ComponentListener,KeyListener, MouseListener
{
    ...
    public void updateJar(){
        try{
            ...
            URL website = new URL("https://github.com/lukasaldersley/Raumklima/raw/V1.0/Release/Raumklima.jar");
            ReadableByteChannel rbc = Channels.newChannel(website.openStream());
    ...
    public boolean checkIfUpdateAvailable(){
        try{
            URL website = new URL("https://raw.githubusercontent.com/lukasaldersley/Raumklima/V1.0/Release/VERSION");
