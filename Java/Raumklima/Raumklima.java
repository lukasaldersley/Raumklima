...
public class Raumklima implements ActionListener, WindowListener, WindowStateListener, ChartMouseListener,
	...
	// Definitions below are the fallback option, in case the config-file doesn't
	// exist and can't be loaded
	...
	public static void main(String[] args) {// Startet das Programm (ggf mnit debug/logging)
		for (int i = 0; i < args.length; i++) {
			 ...
			 * 
			 * if (args[i].equalsIgnoreCase("log") || args[i].equalsIgnoreCase("l") ||
			 * args[i].equalsIgnoreCase("/log") || args[i].equalsIgnoreCase("/l") ||
			 * args[i].equalsIgnoreCase("-log") || args[i].equalsIgnoreCase("-l")) { logging
			 * = true; log(""); System.out.println("Dateiname für die Aufzeichnung: " +
			 * logFile.getName()); } if (args[i].equalsIgnoreCase("debug") ||
			 * args[i].equalsIgnoreCase("d") || args[i].equalsIgnoreCase("/debug") ||
			 * args[i].equalsIgnoreCase("/d") || args[i].equalsIgnoreCase("-debug") ||
			 * args[i].equalsIgnoreCase("-d")) { debug = true;
			 * logln("Debugmodus aktiviert"); } if (args[i].equalsIgnoreCase("f") ||
			 * args[i].equalsIgnoreCase("file") || args[i].equalsIgnoreCase("-f") ||
			 * args[i].equalsIgnoreCase("-file") || args[i].equalsIgnoreCase("/f") ||
			 * args[i].equalsIgnoreCase("/file")) { logln("Datei wird direkt gelesen");
			 * fileSpecifiedAsParameter = true; specifiedFile = args[i + 1]; i++; } if
			 * (args[i].equalsIgnoreCase("u") || args[i].equalsIgnoreCase("/u") ||
			 * args[i].equalsIgnoreCase("-u")) { fromUpdate = true; } if
			 * (args[i].equalsIgnoreCase("du") || args[i].equalsIgnoreCase("/du") ||
			 * args[i].equalsIgnoreCase("-du")) { fromUpdate = true; debug = true;
			 * logln("Debugmodus aktiviert"); } if (args[i].equalsIgnoreCase("lu") ||
			 * args[i].equalsIgnoreCase("/lu") || args[i].equalsIgnoreCase("-lu")) {
			 * fromUpdate = true; logging = true; log("");
			 * System.out.println("Dateiname für die Aufzeichnung: " + logFile.getName()); }
			 * if (args[i].equalsIgnoreCase("fu") || args[i].equalsIgnoreCase("/fu") ||
			 * args[i].equalsIgnoreCase("-fu")) { fromUpdate = true;
			 * logln("Datei wird direkt gelesen"); fileSpecifiedAsParameter = true;
			 * specifiedFile = args[i + 1]; i++; }
			 * 
			 * if (args[i].equalsIgnoreCase("dlu") || args[i].equalsIgnoreCase("-dlu") ||
			 * args[i].equalsIgnoreCase("/dlu")) { debug = true;
			 * logln("Debugmodus aktiviert"); logging = true; log("");
			 * System.out.println("Dateiname für die Aufzeichnung: " + logFile.getName()); }
			 * if (args[i].equalsIgnoreCase("lfu") || args[i].equalsIgnoreCase("-lfu") ||
			 * args[i].equalsIgnoreCase("/lfu")) { logging = true; log("");
			 * System.out.println("Dateiname für die Aufzeichnung: " + logFile.getName());
			 * logln("Datei wird direkt gelesen"); fileSpecifiedAsParameter = true;
			 * specifiedFile = args[i + 1]; i++; } if (args[i].equalsIgnoreCase("dfu") ||
			 * args[i].equalsIgnoreCase("-dfu") || args[i].equalsIgnoreCase("/dfu")) { debug
			 * = true; logln("Debugmodus aktiviert"); logln("Datei wird direkt gelesen");
			 * fileSpecifiedAsParameter = true; specifiedFile = args[i + 1]; i++; }
			 * 
			 * if (args[i].equalsIgnoreCase("dlfu") || args[i].equalsIgnoreCase("/dlfu") ||
			 * args[i].equalsIgnoreCase("-dlfu")) { fromUpdate = true;
			 * 
			 * debug = true; logln("Debugmodus aktiviert"); logging = true; log("");
			 * System.out.println("Dateiname für die Aufzeichnung: " + logFile.getName());
			 * logln("Datei wird direkt gelesen"); fileSpecifiedAsParameter = true;
			 * specifiedFile = args[i + 1]; i++; } if (args[i].equalsIgnoreCase("dlf") ||
			 * args[i].equalsIgnoreCase("-dlf") || args[i].equalsIgnoreCase("/dlf") ||
			 ...
			 * args[i].equalsIgnoreCase("/ldf")) { debug = true;
			 * logln("Debugmodus aktiviert"); logging = true; log("");
			 * System.out.println("Dateiname für die Aufzeichnung: " + logFile.getName());
			 * logln("Datei wird direkt gelesen"); fileSpecifiedAsParameter = true;
			 * specifiedFile = args[i + 1]; i++; } if (args[i].equalsIgnoreCase("dl") ||
			 * args[i].equalsIgnoreCase("-dl") || args[i].equalsIgnoreCase("/dl") ||
			 * args[i].equalsIgnoreCase("ld") || args[i].equalsIgnoreCase("-ld") ||
			 * args[i].equalsIgnoreCase("/ld")) { debug = true;
			 * logln("Debugmodus aktiviert"); logging = true; log("");
			 * System.out.println("Dateiname für die Aufzeichnung: " + logFile.getName()); }
			 * if (args[i].equalsIgnoreCase("lf") || args[i].equalsIgnoreCase("-lf") ||
			 * args[i].equalsIgnoreCase("/lf") || args[i].equalsIgnoreCase("fl") ||
			 * args[i].equalsIgnoreCase("-fl") || args[i].equalsIgnoreCase("/fl")) { logging
			 * = true; log(""); System.out.println("Dateiname für die Aufzeichnung: " +
			 * logFile.getName()); logln("Datei wird direkt gelesen");
			 * fileSpecifiedAsParameter = true; specifiedFile = args[i + 1]; i++; } if
			 * (args[i].equalsIgnoreCase("df") || args[i].equalsIgnoreCase("-df") ||
			 * args[i].equalsIgnoreCase("/df") || args[i].equalsIgnoreCase("fd") ||
			 * args[i].equalsIgnoreCase("-fd") || args[i].equalsIgnoreCase("/fd")) { debug =
			 * true; logln("Debugmodus aktiviert"); logln("Datei wird direkt gelesen");
			 * fileSpecifiedAsParameter = true; specifiedFile = args[i + 1]; i++; } else if
			 ...
			 * args[i].equalsIgnoreCase("-?") || args[i].equalsIgnoreCase("-help") ||
			 * args[i].equalsIgnoreCase("-h")) { System.out.println(
	 ...
	 * 
	 * @param newTitleNumber the number that should be displayed in the Titlebar on
	 *                       the MainWindow
	 * @param newPrevious    the preceding instance of Raumklima (only used to
	 *                       update the numbering scheme if a window is closed or
	 *                       opened)
	 * @param newNext        the following instance of Raumklima (only used to
	 *                       update the numbering scheme if a window is closed or
	 *                       opened)
	 */
	...
	private JFreeChart createDataset() {
		...
		try {
			...
			if (geoMode) {
				...
				for (int i = 0; i < numberOfGraphs / 2; i++) {// WORRY I'm changing i in the loop
					...
					try {
						xYSeries[2 * i] = new XYSeries(
								dataValueDescriptors[i].substring(0, dataValueDescriptors[i].indexOf('(')));
						xYSeries[2 * i + 1] = new XYSeries(
								dataValueDescriptors[i].substring(0, dataValueDescriptors[i].indexOf('(')) + "(log)");// REMOVE
		...
		if (geoMode) {
			...
			// REWORK
			/*
			 * chart = ChartFactory.createXYLineChart(null, "Zeit (etwa " + 10 *
			 * interpolationFactor + " Sekunden zwischen den Messwerten)", "Werte",
			 * xYSeriesCollection);
			 */
			chart = ChartFactory.createXYLineChart(null, "Nr der Datenreihe", "Werte", xYSeriesCollection);
		}
