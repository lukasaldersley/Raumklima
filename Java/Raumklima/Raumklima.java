...
public class Raumklima implements ActionListener,WindowListener,WindowStateListener,ChartMouseListener,ComponentListener,KeyListener, MouseListener, FocusListener
{
    ...
    private void setupChangeKeyCombinationHelperWindow() {
        try{
            ...
            setNewKeyCombinationWindow.setTitle("Tastenkombination Ã¤ndern");
    ...
    private void setupSettingsWindow(){
        ...
        GeoModeOkButton=new JButton("Ãœbernehmen");
    ...
    private JFreeChart createDataset(){
        ...
        JFreeChart chart = ChartFactory.createXYLineChart(null,"Zeit","Werte",xYSeriesCollection);
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        else if(event.getSource()==changeInterpolationSettings){
        ...
        if(event.getSource()==GeoModeOkButton){
    ...
    private String getKeyStringFromKeyCode(int code){
        //mir ist bekannt, dass die Methode KeyEvent.getKeyText(int) existiert, jedoch sind ausgaben wie "Zirkumflex (Dead)" meiner meinung nach unverstÃ¤ndlicher als "^"
        switch(code){
