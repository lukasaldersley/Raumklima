...
public class STATE {
    ...
    public static boolean allowKeyCombinationChange=false;
    public static boolean bottomPanelExpanded=false;
    public static boolean changeAltDown=false;
    public static boolean changeCtrlDown=false;
    public static boolean changeShiftDown=false;
    public static boolean jFilePickerFailed=false;
    public static boolean fullscreen=false;
    public static boolean saveJpeg=true;
    public static boolean savePng=true;
    public static boolean autoUpdate=true;
    public static boolean fullscreenOk=false;
    public static boolean bottomPanelExpandedOnStartup=false;
    public static boolean fullscreenOnStartup=false;
    public static boolean keyCombinationsEnabled=true;
	public static boolean isCustomInterpolated;
	public static int interpolationOffset=0;
	public static int interpolationFactor=0;
    static boolean getImageSizeAutomatically;
    static int imageWidth;
    static int imageHeight;


    static Dimension fullscreenDimension;
 static Dimension windowDimension;
 static Dimension bottomPanelDimension;
static Dimension topPanelDimension;
}
