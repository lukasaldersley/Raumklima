...
extends ApplicationFrame {
    public TimeSeriesDemo8(String string) {
        super(string);
        JPanel jPanel = TimeSeriesDemo8.createDemoPanel();
        jPanel.setPreferredSize(new Dimension(500, 270));
        this.setContentPane((Container)jPanel);
    }

    private static XYDataset createDataset() {
        TimeSeries timeSeries = TimeSeriesDemo8.createEURTimeSeries();
        TimeSeries timeSeries2 = MovingAverage.createMovingAverage((TimeSeries)timeSeries, (String)"30 day moving average", (int)30, (int)30);
    ...
    private static JFreeChart createChart(XYDataset xYDataset) {
        JFreeChart jFreeChart = ChartFactory.createTimeSeriesChart((String)"Time Series Demo 8", (String)"Date", (String)"Value", (XYDataset)xYDataset, (boolean)true, (boolean)true, (boolean)false);
        ...
        xYLineAndShapeRenderer.setBaseToolTipGenerator((XYToolTipGenerator)standardXYToolTipGenerator);
        ChartUtilities.applyCurrentTheme((JFreeChart)jFreeChart);
        return jFreeChart;
    }

    public static JPanel createDemoPanel() {
        JFreeChart jFreeChart = TimeSeriesDemo8.createChart(TimeSeriesDemo8.createDataset());
    ...
    public static void main(String[] arrstring) {
        ...
        RefineryUtilities.centerFrameOnScreen((Window)((Object)timeSeriesDemo8));
