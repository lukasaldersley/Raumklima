...
extends ApplicationFrame {
    ...
    private static JFreeChart createChart() {
        XYDataset xYDataset = MultipleAxisDemo3.createDataset("Series 1", 100.0, (RegularTimePeriod)new Minute(), 200);
        JFreeChart jFreeChart = ChartFactory.createTimeSeriesChart((String)"Multiple Axis Demo 3", (String)"Time of Day", (String)"Primary Range Axis", (XYDataset)xYDataset, (boolean)true, (boolean)true, (boolean)false);
        ...
        XYDataset xYDataset2 = MultipleAxisDemo3.createDataset("Series 2", 1000.0, (RegularTimePeriod)new Minute(), 170);
