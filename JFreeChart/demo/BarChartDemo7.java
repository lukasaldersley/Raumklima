...
extends ApplicationFrame {
    public BarChartDemo7(String string) {
        super(string);
        JPanel jPanel = BarChartDemo7.createDemoPanel();
    ...
    private static CategoryDataset createDataset() {
        ...
        defaultCategoryDataset.addValue(0.0, (Comparable)((Object)string3), (Comparable)((Object)string6));
    ...
    private static JFreeChart createChart(CategoryDataset categoryDataset) {
        JFreeChart jFreeChart = ChartFactory.createBarChart((String)"Bar Chart Demo 7", (String)"Category", (String)"Value", (CategoryDataset)categoryDataset);
        jFreeChart.removeLegend();
        CategoryPlot categoryPlot = (CategoryPlot)jFreeChart.getPlot();
        categoryPlot.setRangePannable(true);
        IntervalMarker intervalMarker = new IntervalMarker(4.5, 7.5);
        ...
        ItemLabelPosition itemLabelPosition = new ItemLabelPosition(ItemLabelAnchor.INSIDE12, TextAnchor.CENTER_RIGHT, TextAnchor.CENTER_RIGHT, -1.5707963267948966);
        barRenderer.setBasePositiveItemLabelPosition(itemLabelPosition);
        ItemLabelPosition itemLabelPosition2 = new ItemLabelPosition(ItemLabelAnchor.OUTSIDE12, TextAnchor.CENTER_LEFT, TextAnchor.CENTER_LEFT, -1.5707963267948966);
        barRenderer.setPositiveItemLabelPositionFallback(itemLabelPosition2);
    ...
    public static JPanel createDemoPanel() {
        JFreeChart jFreeChart = BarChartDemo7.createChart(BarChartDemo7.createDataset());
    ...
    public static void main(String[] arrstring) {
        ...
        barChartDemo7.pack();
        RefineryUtilities.centerFrameOnScreen((Window)((Object)barChartDemo7));
