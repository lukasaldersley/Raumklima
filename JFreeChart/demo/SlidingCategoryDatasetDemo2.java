...
extends ApplicationFrame {
    public SlidingCategoryDatasetDemo2(String string) {
        super(string);
        this.setDefaultCloseOperation(3);
        this.setContentPane((Container)SlidingCategoryDatasetDemo2.createDemoPanel());
    }
    ...
    public static void main(String[] arrstring) {
        ...
        RefineryUtilities.centerFrameOnScreen((Window)((Object)slidingCategoryDatasetDemo2));
    ...
    implements ChangeListener {
        ...
        private static CategoryDataset createDataset() {
            ...
            for (int i = 0; i < 50; ++i) {
                defaultCategoryDataset.addValue(Math.random() * 100.0, (Comparable)((Object)"S1"), (Comparable)((Object)("S" + i)));
            }
            return defaultCategoryDataset;
        }

        private static JFreeChart createChart(CategoryDataset categoryDataset) {
            JFreeChart jFreeChart = ChartFactory.createBarChart((String)"SlidingCategoryDatasetDemo2", (String)"Series", (String)"Value", (CategoryDataset)categoryDataset, (PlotOrientation)PlotOrientation.VERTICAL, (boolean)false, (boolean)true, (boolean)false);
